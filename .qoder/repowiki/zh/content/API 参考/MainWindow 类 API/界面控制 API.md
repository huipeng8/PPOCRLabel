...
图表来源
- [PPOCRLabel.py](file://PPOCRLabel.py#L1460-L1659)
- [canvas.py](file://libs/canvas.py#L1-L120)
- [zoomWidget.py](file://libs/zoomWidget.py#L1-L35)
- [toolBar.py](file://libs/toolBar.py#L1-L48)
...
图表来源
- [PPOCRLabel.py](file://PPOCRLabel.py#L1460-L1659)
- [canvas.py](file://libs/canvas.py#L120-L220)
- [zoomWidget.py](file://libs/zoomWidget.py#L1-L35)
...
- setCreateMode
  ...
  - 快捷键：w
  - 章节来源
    - [PPOCRLabel.py](file://PPOCRLabel.py#L1460-L1473)
    - [canvas.py](file://libs/canvas.py#L108-L120)
...
章节来源
- [PPOCRLabel.py](file://PPOCRLabel.py#L2022-L2091)
- [zoomWidget.py](file://libs/zoomWidget.py#L1-L35)
...
- 菜单项与动作
  ...
  - 章节来源
    - [utils.py](file://libs/utils.py#L51-L83)
    - [utils.py](file://libs/utils.py#L108-L111)
...
- 快捷键示例（节选）
  ...
  - 章节来源
    ...
    - [utils.py](file://libs/utils.py#L336-L366)
...
- 图像缩放滑杆联动
  ...
  - 章节来源
    - [PPOCRLabel.py](file://PPOCRLabel.py#L1603-L1606)
...
- 画布与滚动区域
  ...
  - 章节来源
    ...
    - [canvas.py](file://libs/canvas.py#L669-L714)
...
- 坐标提示与尺寸提示
  ...
  - 章节来源
    - [canvas.py](file://libs/canvas.py#L130-L151)

- 选择高亮与顶点高亮
  - Canvas 在悬停/选择时高亮形状与顶点，改变光标样式。
  - 章节来源
    - [canvas.py](file://libs/canvas.py#L222-L253)

- 滚动联动与平移
  - Canvas 鼠标拖拽触发滚动请求；MainWindow 根据 delta 更新滚动条。
  - 章节来源
    - [canvas.py](file://libs/canvas.py#L214-L219)
    - [PPOCRLabel.py](file://PPOCRLabel.py#L2022-L2025)

- 动作启用/禁用
  - 根据当前状态（有无选择、是否编辑模式、是否有文件）动态启用/禁用动作。
  - 章节来源
    - [PPOCRLabel.py](file://PPOCRLabel.py#L1650-L1659)
...
- 适配模式
  ...
  - 章节来源
    - [PPOCRLabel.py](file://PPOCRLabel.py#L1460-L1473)
    - [PPOCRLabel.py](file://PPOCRLabel.py#L2093-L2103)
...
## 附录
- 关键 API 路径索引
  - setCreateMode：[PPOCRLabel.py](file://PPOCRLabel.py#L1460-L1473)
  - setEditMode：[PPOCRLabel.py](file://PPOCRLabel.py#L1460-L1473)
  - setZoom：[PPOCRLabel.py](file://PPOCRLabel.py#L2026-L2038)
  - addZoom：[PPOCRLabel.py](file://PPOCRLabel.py#L2032-L2038)
  - zoomRequest：[PPOCRLabel.py](file://PPOCRLabel.py#L2039-L2091)
  - setFitWindow：[PPOCRLabel.py](file://PPOCRLabel.py#L2093-L2098)
  - setFitWidth：[PPOCRLabel.py](file://PPOCRLabel.py#L2099-L2103)
  - scrollRequest：[PPOCRLabel.py](file://PPOCRLabel.py#L2022-L2025)
  - Canvas 缩放与绘制：[canvas.py](file://libs/canvas.py#L571-L661)
  - ZoomWidget：[zoomWidget.py](file://libs/zoomWidget.py#L1-L35)
  - 工具栏按钮样式：[toolBar.py](file://libs/toolBar.py#L1-L48)
  - 动作与快捷键工具：[utils.py](file://libs/utils.py#L51-L83)
  - 设置键名：[constants.py](file://libs/constants.py#L1-L33)
  - 设置持久化：[settings.py](file://libs/settings.py#L1-L62)
  - Shape 数据模型：[shape.py](file://libs/shape.py#L1-L120)