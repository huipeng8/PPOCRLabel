...
**图表来源**
- [PPOCRLabel.py](file://PPOCRLabel.py#L1-L50)
- [libs/hashableQListWidgetItem.py](file://libs/hashableQListWidgetItem.py#L1-L24)
- [libs/unique_label_qlist_widget.py](file://libs/unique_label_qlist_widget.py#L1-L49)

**章节来源**
- [PPOCRLabel.py](file://PPOCRLabel.py#L1-L131)
...
**图表来源**
- [libs/hashableQListWidgetItem.py](file://libs/hashableQListWidgetItem.py#L22-L24)
...
**图表来源**
- [libs/editinlist.py](file://libs/editinlist.py#L12-L22)
- [PPOCRLabel.py](file://PPOCRLabel.py#L1890-L1914)
...
**图表来源**
- [PPOCRLabel.py](file://PPOCRLabel.py#L30-L75)
- [libs/hashableQListWidgetItem.py](file://libs/hashableQListWidgetItem.py#L15-L15)
...
**章节来源**
- [PPOCRLabel.py](file://PPOCRLabel.py#L128-L131)
- [libs/hashableQListWidgetItem.py](file://libs/hashableQListWidgetItem.py#L15-L15)
