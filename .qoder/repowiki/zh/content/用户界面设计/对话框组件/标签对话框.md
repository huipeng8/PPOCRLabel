...
图表来源
- [PPOCRLabel.py](file://PPOCRLabel.py#L262-L264)
- [libs/labelDialog.py](file://libs/labelDialog.py#L30-L63)
- [libs/keyDialog.py](file://libs/keyDialog.py#L27-L47)
- [libs/utils.py](file://libs/utils.py#L95-L96)

章节来源
- [libs/labelDialog.py](file://libs/labelDialog.py#L1-L119)
- [libs/utils.py](file://libs/utils.py#L95-L96)
- [libs/keyDialog.py](file://libs/keyDialog.py#L1-L200)
- [PPOCRLabel.py](file://PPOCRLabel.py#L262-L264)
...
- [libs/utils.py](file://libs/utils.py#L95-L96)
- [libs/keyDialog.py](file://libs/keyDialog.py#L27-L130)
...
章节来源
- [libs/labelDialog.py](file://libs/labelDialog.py#L65-L81)
...
章节来源
- [libs/labelDialog.py](file://libs/labelDialog.py#L74-L81)
- [libs/labelDialog.py](file://libs/labelDialog.py#L108-L118)
...
章节来源
- [libs/labelDialog.py](file://libs/labelDialog.py#L83-L86)
- [libs/keyDialog.py](file://libs/keyDialog.py#L179-L205)
...
章节来源
- [libs/labelDialog.py](file://libs/labelDialog.py#L106)
...
图表来源
- [PPOCRLabel.py](file://PPOCRLabel.py#L1951-L1958)
- [libs/labelDialog.py](file://libs/labelDialog.py#L65-L106)
...
图表来源
- [libs/labelDialog.py](file://libs/labelDialog.py#L25-L26)
- [libs/utils.py](file://libs/utils.py#L95-L96)
