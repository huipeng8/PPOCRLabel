...
图表来源
- [PPOCRLabel.py](file://PPOCRLabel.py#L514-L541)
...
- [libs/utils.py](file://libs/utils.py#L104-L413)
- [PPOCRLabel.py](file://PPOCRLabel.py#L143-L800)
...
图表来源
- [libs/canvas.py](file://libs/canvas.py#L254-L398)
...
- [libs/canvas.py](file://libs/canvas.py#L682-L697)
...
- [libs/canvas.py](file://libs/canvas.py#L226-L252)
- [libs/utils.py](file://libs/utils.py#L104-L105)
- [libs/utils.py](file://libs/utils.py#L373-L403)
- [PPOCRLabel.py](file://PPOCRLabel.py#L2218-L2230)
...
章节来源
- [libs/canvas.py](file://libs/canvas.py#L170-L180)
- [libs/canvas.py](file://libs/canvas.py#L447-L494)
- [libs/canvas.py](file://libs/canvas.py#L795-L798)
- [libs/shape.py](file://libs/shape.py#L91-L104)
- [libs/shape.py](file://libs/shape.py#L248-L252)
- [libs/shape.py](file://libs/shape.py#L212-L228)
...
- 创建矩形标注框
  - 触发：点击“创建矩形框”或按键W
  - 实现路径：[libs/canvas.py](file://libs/canvas.py#L257-L279)，[libs/canvas.py](file://libs/canvas.py#L351-L374)
- 创建四点标注框
  - 触发：点击“创建多点框”或按键Q/Home
  - 实现路径：[libs/canvas.py](file://libs/canvas.py#L170-L180)，[libs/canvas.py](file://libs/canvas.py#L352-L362)
- 移动与复制
  - 实现路径：[libs/canvas.py](file://libs/canvas.py#L190-L198)，[libs/canvas.py](file://libs/canvas.py#L553-L558)
- 旋转
  - 实现路径：[libs/canvas.py](file://libs/canvas.py#L795-L798)，[libs/shape.py](file://libs/shape.py#L91-L104)
- 自动缩放与居中
  - 实现路径：[PPOCRLabel.py](file://PPOCRLabel.py#L2218-L2230)，[libs/utils.py](file://libs/utils.py#L406-L412)

章节来源
- [libs/canvas.py](file://libs/canvas.py#L170-L180)
- [libs/canvas.py](file://libs/canvas.py#L257-L279)
- [libs/canvas.py](file://libs/canvas.py#L351-L374)
...
图表来源
- [libs/canvas.py](file://libs/canvas.py#L20-L22)
- [libs/shape.py](file://libs/shape.py#L18-L21)
- [libs/utils.py](file://libs/utils.py#L104-L120)
- [libs/constants.py](file://libs/constants.py#L13-L32)
- [PPOCRLabel.py](file://PPOCRLabel.py#L86-L131)
...
- 无法绘制或越界
  ...
  - 参考路径：[libs/canvas.py](file://libs/canvas.py#L433-L445)，[libs/canvas.py](file://libs/canvas.py#L498-L509)
- 顶点吸附不灵敏
  - 调整epsilon阈值与nearestVertex逻辑
  - 参考路径：[libs/canvas.py](file://libs/canvas.py#L229-L237)，[libs/shape.py](file://libs/shape.py#L230-L234)
- 文本显示异常
  - 检查字体大小与MIN_Y_LABEL设置
  - 参考路径：[libs/shape.py](file://libs/shape.py#L169-L187)，[libs/shape.py](file://libs/shape.py#L189-L206)
- 自动缩放不符合预期
  - 检查面积映射与zoomRequest触发条件
  - 参考路径：[libs/utils.py](file://libs/utils.py#L406-L412)，[PPOCRLabel.py](file://PPOCRLabel.py#L2218-L2230)

章节来源
- [libs/canvas.py](file://libs/canvas.py#L433-L445)
- [libs/canvas.py](file://libs/canvas.py#L498-L509)
- [libs/canvas.py](file://libs/canvas.py#L229-L237)
- [libs/shape.py](file://libs/shape.py#L169-L187)
- [libs/shape.py](file://libs/shape.py#L189-L206)
- [libs/utils.py](file://libs/utils.py#L406-L412)
- [PPOCRLabel.py](file://PPOCRLabel.py#L2218-L2230)
...
章节来源
- [README.md](file://README.md#L229-L251)
