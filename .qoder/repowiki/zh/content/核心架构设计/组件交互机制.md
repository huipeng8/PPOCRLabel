...
图表来源
- [PPOCRLabel.py](file://PPOCRLabel.py#L143-L260)
...
图表来源
- [PPOCRLabel.py](file://PPOCRLabel.py#L1600-L1690)
- [canvas.py](file://libs/canvas.py#L32-L40)
- [shape.py](file://libs/shape.py#L120-L210)
- [settings.py](file://libs/settings.py#L21-L62)
...
- 示例路径（不展示代码内容）：
  - Canvas 自定义信号定义：[canvas.py](file://libs/canvas.py#L32-L40)
  - MainWindow 连接 Canvas 信号：[PPOCRLabel.py](file://PPOCRLabel.py#L516-L533)
  - MainWindow 响应 selectionChanged/updateBoxlist：[PPOCRLabel.py](file://PPOCRLabel.py#L1607-L1659)
  - MainWindow 响应 shapeMoved/updateBoxlist：[PPOCRLabel.py](file://PPOCRLabel.py#L1560-L1575)

章节来源
- [canvas.py](file://libs/canvas.py#L32-L40)
- [PPOCRLabel.py](file://PPOCRLabel.py#L516-L533)
- [PPOCRLabel.py](file://PPOCRLabel.py#L1560-L1659)
...
- [PPOCRLabel.py](file://PPOCRLabel.py#L1560-L1575)
- [PPOCRLabel.py](file://PPOCRLabel.py#L1946-L1999)
...
- 关键路径（不展示代码内容）：
  - Shape 属性与绘制：[shape.py](file://libs/shape.py#L35-L120)
  - MainWindow 添加/移除标签与检测框：[PPOCRLabel.py](file://PPOCRLabel.py#L1660-L1717)
  - MainWindow 加载/保存标注：[PPOCRLabel.py](file://PPOCRLabel.py#L1718-L1839)

章节来源
- [shape.py](file://libs/shape.py#L35-L120)
- [PPOCRLabel.py](file://PPOCRLabel.py#L1660-L1717)
- [PPOCRLabel.py](file://PPOCRLabel.py#L1718-L1839)
...
- 关键路径（不展示代码内容）：
  - Settings 类与持久化：[settings.py](file://libs/settings.py#L21-L62)
  - MainWindow 读取/写入设置：[PPOCRLabel.py](file://PPOCRLabel.py#L1210-L1220)
  - MainWindow 关闭事件保存设置：[PPOCRLabel.py](file://PPOCRLabel.py#L2332-L2359)

章节来源
- [settings.py](file://libs/settings.py#L21-L62)
- [PPOCRLabel.py](file://PPOCRLabel.py#L1210-L1220)
- [PPOCRLabel.py](file://PPOCRLabel.py#L2332-L2359)
...
- 关键路径（不展示代码内容）：
  - Worker 线程与信号：[autoDialog.py](file://libs/autoDialog.py#L22-L100)
  - AutoDialog 与主线程交互：[autoDialog.py](file://libs/autoDialog.py#L103-L196)
  - MainWindow 触发自动识别：[PPOCRLabel.py](file://PPOCRLabel.py#L1993-L1999)
...
- [PPOCRLabel.py](file://PPOCRLabel.py#L1993-L1999)
...
- 关键路径（不展示代码内容）：
  - 就地编辑：[editinlist.py](file://libs/editinlist.py#L7-L34)
  - 唯一标签列表：[unique_label_qlist_widget.py](file://libs/unique_label_qlist_widget.py#L7-L49)
  - 可哈希列表项：[hashableQListWidgetItem.py](file://libs/hashableQListWidgetItem.py#L18-L24)
  - 列表与 Shape 的增删改：[PPOCRLabel.py](file://PPOCRLabel.py#L1660-L1717)
...
- 关键路径（不展示代码内容）：
  - 标签输入：[labelDialog.py](file://libs/labelDialog.py#L30-L119)
  - 键值输入：[keyDialog.py](file://libs/keyDialog.py#L27-L209)
  - 颜色选择：[colorDialog.py](file://libs/colorDialog.py#L17-L42)
  - 缩放控件：[zoomWidget.py](file://libs/zoomWidget.py#L19-L35)
...
- 无法保存或设置未生效：
  ...
  - 参考路径：[settings.py](file://libs/settings.py#L21-L62)、[PPOCRLabel.py](file://PPOCRLabel.py#L2332-L2359)
- 列表项不可编辑或异常触发：
  - 确认使用 HashableQListWidgetItem；检查 EditInList 的就地编辑逻辑。
  - 参考路径：[hashableQListWidgetItem.py](file://libs/hashableQListWidgetItem.py#L18-L24)、[editinlist.py](file://libs/editinlist.py#L7-L34)
- 自动识别无响应或卡顿：
  - 检查 AutoDialog 的 Worker 线程是否启动；确认信号连接是否正确；查看日志输出。
  - 参考路径：[autoDialog.py](file://libs/autoDialog.py#L22-L100)、[autoDialog.py](file://libs/autoDialog.py#L103-L196)
- 缩放/滚动异常：
  - 确认 Canvas 的 zoomRequest/scrollRequest 是否被 MainWindow 正确处理；检查 MainWindow 的 zoomRequest/scrollRequest 实现。
  - 参考路径：[canvas.py](file://libs/canvas.py#L715-L736)、[PPOCRLabel.py](file://PPOCRLabel.py#L2022-L2092)
...
- [PPOCRLabel.py](file://PPOCRLabel.py#L2022-L2092)
