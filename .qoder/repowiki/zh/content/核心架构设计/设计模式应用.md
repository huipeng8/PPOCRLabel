...
图表来源
- [PPOCRLabel.py](file://PPOCRLabel.py#L530-L540)
- [canvas.py](file://libs/canvas.py#L32-L40)
- [settings.py](file://libs/settings.py#L21-L62)
- [labelDialog.py](file://libs/labelDialog.py#L30-L64)
- [colorDialog.py](file://libs/colorDialog.py#L17-L42)
- [autoDialog.py](file://libs/autoDialog.py#L103-L147)
...
图表来源
- [utils.py](file://libs/utils.py#L33-L83)
- [PPOCRLabel.py](file://PPOCRLabel.py#L550-L620)
...
图表来源
- [canvas.py](file://libs/canvas.py#L32-L40)
- [PPOCRLabel.py](file://PPOCRLabel.py#L529-L533)
...
- 设置加载失败
  ...
  - 参考路径：[settings.py](file://libs/settings.py#L46-L54)
- 信号未触发
  - 现象：UI 不响应画布事件。
  - 排查：确认 MainWindow 是否正确连接 Canvas 的信号；检查信号名称与参数是否匹配。
  - 参考路径：[canvas.py](file://libs/canvas.py#L32-L40)、[PPOCRLabel.py](file://PPOCRLabel.py#L529-L533)
- 对话框弹出异常
  - 现象：自动标注或颜色选择对话框无法关闭或无响应。
  - 排查：确认线程与信号连接是否正确；检查 reject/validate 流程。
  - 参考路径：[autoDialog.py](file://libs/autoDialog.py#L142-L196)、[colorDialog.py](file://libs/colorDialog.py#L17-L42)

章节来源
- [settings.py](file://libs/settings.py#L46-L54)
- [canvas.py](file://libs/canvas.py#L32-L40)
- [PPOCRLabel.py](file://PPOCRLabel.py#L529-L533)
- [autoDialog.py](file://libs/autoDialog.py#L142-L196)
- [colorDialog.py](file://libs/colorDialog.py#L17-L42)
