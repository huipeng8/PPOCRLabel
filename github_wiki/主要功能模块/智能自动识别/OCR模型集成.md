...
- 常用调用路径参考
  - 文本检测：参见 [PPOCRLabel.py](PPOCRLabel.md)
  - 文本识别（单框/单元格）：参见 [PPOCRLabel.py](PPOCRLabel.md)
  - 自动识别流程：参见 [libs/autoDialog.py](autoDialog.md)
  - 图像预处理工具：参见 [libs/utils.py](utils.md)