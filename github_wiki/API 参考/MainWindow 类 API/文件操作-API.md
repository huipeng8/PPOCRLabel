...
### API 定义与调用示例（路径引用）
- 打开目录
  - 菜单/快捷键绑定：参见 [PPOCRLabel.py](PPOCRLabel.md)
  - 方法实现：参见 [PPOCRLabel.py](PPOCRLabel.md)
- 打开数据集目录
  - 方法实现：参见 [PPOCRLabel.py](PPOCRLabel.md)
- 保存文件
  - 菜单/快捷键绑定：参见 [PPOCRLabel.py](PPOCRLabel.md)
...
- 关闭文件
  - 方法实现：参见 [PPOCRLabel.py](PPOCRLabel.md)
- 自动保存触发
  - 线程调用：参见 [autoDialog.py](autoDialog.md)

### 文件格式与编码
- 编码
  - 默认UTF-8，参见 [constants.py](constants.md)
- 标注文件
  - 基于Label.txt与fileState.txt，参见 [PPOCRLabel.py](PPOCRLabel.md)、[PPOCRLabel.py](PPOCRLabel.md)
- CreateML导出
  - Writer/Reader实现，参见 [create_ml_io.py](create_ml_io.md)